                    ...
                    foreach (string file in dlg.FileNames)
                    {
                        if (File.Exists(file))
                        {
                            try
                            {
                                ...
                                {
                                    tmpImgMD5 = ToolSecurityHelper.GetMD5(file);
    ...
    public class ImageEntity
    {
            ...
            : this()
        {
            ...
            try
            {
                ...
                this.MD5 = ToolSecurityHelper.GetMD5(fullName);
            }
            catch (Exception ex)
            {
                this.Image = null;
